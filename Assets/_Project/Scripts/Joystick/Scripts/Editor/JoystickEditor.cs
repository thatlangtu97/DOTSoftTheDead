...
public class JoystickEditor : Editor
{
    ...
    protected SerializedProperty bgRotation;
    ...
    protected virtual void OnEnable()
    {
        ...
        bgRotation = serializedObject.FindProperty("bgRotation");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(bgRotation, new GUIContent("Handle", "The handle's RectTransform component."));
    }
}